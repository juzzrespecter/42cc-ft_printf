...
/*   Updated: 2020/01/22 17:47:32 by danrodri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	gt0x7f(wchar_t *u8char_str, wchar_t u8char)
{
	u8char_str[0] = (char)(((u8char >> 6) & 0x1f) | 0xc0);
	u8char_str[1] = (char)(((u8char >> 0) & 0x3f) | 0x80);
}

static void	gt0x7ff(wchar_t *u8char_str, wchar u8char)
{
...
static void	gt0xffff(wchar_t *u8char_str, wchar_t u8char)
{
